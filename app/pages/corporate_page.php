...
$TITLEPAGE = 'Corporativo do '.$_SESSION['DataAccount']['social'].' - '.$SERVER_NAME;
...
?>        
        <div class="mininav">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-users"></i> Corporativo</li>
                </ol>
            </nav>
        </div>
        <?php
        ...
        <section class="cardstool">
            <h1><i class="fa-solid fa-screwdriver-wrench"></i> Minhas ferramentas</h1>
                        <?php
                        ...
                        if(isset($UserPcName)){
                            ...
                            echo'<button type="button" class="css-button-3d--sky" data-bs-toggle="modal" data-bs-target="#modalnetworkuser"><img src="../assets/network_user.png" alt="networklogo"/><h5 class="card-title">Cfg. de rede</h5></button>
