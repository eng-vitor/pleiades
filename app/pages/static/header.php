            ...
            <div class="menusystemadmin">
                ...
                <div class="usernav">
                    ...
                    <ul class="dropdown-menu" id="userdropdown">
                        ...
                        <?= ($_SESSION['DataAccount']['classe']!=1) ? '<li><a class="dropdown-item" href="system/SystemAdmin.php"><i class="fa-solid fa-terminal"></i> Acesso admin</a></li>' : ''; ?>
                        <?php if($_SESSION['DataAccount']['classe']==1){ echo ''; }else{ echo '<li>'.(substr($_SERVER['SCRIPT_NAME'], strlen($_SERVER['SCRIPT_NAME']) - 10) === 'System.php') ? '<a class="dropdown-item disabled" href="#"><i class="fa-solid fa-ticket-simple"></i> Acesso de usuário</a>' : '<a class="dropdown-item" href="System.php"><i class="fa-solid fa-ticket-simple"></i> Acesso de usuário</a></li>'; } ?>
                        <li><?= (substr($_SERVER['SCRIPT_NAME'], strlen($_SERVER['SCRIPT_NAME']) - 13) === 'MyProfile.php') ? '<a class="dropdown-item disabled" href="#"><i class="fa-solid fa-user"></i> Meu Perfil</a>' : '<a class="dropdown-item" href="MyProfile.php"><i class="fa-solid fa-user"></i> Meu Perfil</a>'; ?></li>
                        <li><?= (substr($_SERVER['SCRIPT_NAME'], strlen($_SERVER['SCRIPT_NAME']) - 19) === 'Change_Password.php') ? '<a class="dropdown-item disabled" href="#"><i class="fa-solid fa-unlock-keyhole"></i> Alterar senha</a>' : '<a class="dropdown-item" href="Change_Password.php"><i class="fa-solid fa-unlock-keyhole"></i> Alterar senha</a>'; ?></li>
                        <li><hr class="dropdown-divider"></li>
