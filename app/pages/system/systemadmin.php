...
$TITLEPAGE = '[ADMIN] Sistema - '.$SERVER_NAME;
    ...
    <div class="mininav">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="../../scripts/adminquerys/refreshdatadashboard.php"><i class="fa-solid fa-rotate"></i> Atualizar</a></li>
            </ol>
        </nav>
    </div>
    <div class="buttonsdashboard">
        <button type="button" class="css-button-rounded--sky"><h1><i class="fa-regular fa-square-check"></i></h1><h2><?= $_SESSION['DataTotalTicket']; ?></h2>Tickets atendidos</button>
        <button type="button" class="css-button-rounded--sky"><h1><i class="fa-solid fa-hourglass-start fa-fade"></i></h1><h2><?= $_SESSION['DataTicketsPending']['count']; ?></h2>Tickets pendentes</button>
        <button type="button" class="css-button-rounded--sky"><h1><i class="fa-solid fa-hourglass-half fa-beat-fade"></i></h1><h2><?= $ContForToday; ?></h2>Tickets que vencem hoje</button>
        <button type="button" class="css-button-rounded--sky"><h1><i class="fa-solid fa-hourglass-end fa-shake"></i></h1><h2><?= $ContExpired; ?></h2>Tickets atrasados</button>
    </div>
    <section class="ticketslist">
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><i class="fa-solid fa-tag"></i> Titulo</th>
                        <th scope="col"><i class="fa-solid fa-paper-plane"></i> Designação</th>
                        <th scope="col"><i class="fa-solid fa-stopwatch"></i> SLA</th>
                        <th scope="col"><i class="fa-solid fa-calendar-week"></i> Data SLA</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                       for($j=0; $j<$_SESSION['DataTicketsPending']['count']; $j++){
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$DataTicketFormatadaSLA->format('d/m/Y').' ás '.$DataTicketFormatadaSLA->format('H:i:s').'</td>
                                </tr>';                  
                        }
                    ?>
                </tbody>
            ...
            <?php
                if($_SESSION['DataTicketsPending']['count']==0){
                    echo '<h2><i class="fa-regular fa-folder-open"></i> Sem tickets entre os filtros!</h2>';
                }
            ?>
    </section>
<?php
