...
if(isset($_GET['protocolticket'])){
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> Você precisa selecionar um ticket para atualizar os dados!</div>';
    header("Location: ../../pages/system/ResolveTicket.php");
    exit();
}
