...
if(strlen($NewMessageChat)>=1 and strlen($NewMessageChat)<1000){
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> Não foi possível encaminhar a mensagem! Por favor, tente novamente!</div>';
    header("Location: ../../pages/Ticket.php");
    exit();
}
