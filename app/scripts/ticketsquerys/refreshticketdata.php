...
if(isset($_GET['protocolticket'])){
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-circle-xmark fa-beat"></i> Você precisa selecionar um ticket para atualizar os dados!</div>';
