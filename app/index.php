    ...
    <body>
        <div class="bannerindex puff-in-center">
            ...
            <section class="formlogin" align="center">
                <form action="scripts/login.php" method="POST">
                    <div class="formmodel" align="left">
                        <label for="loginuser"><i class="fa-solid fa-at"></i> Email</label> 
                        <input class="form-control" name="loginuser" id="loginuser" type="email" placeholder="Login" maxlength="100" required/>
                        <label for="loginpass"><i class="fa-solid fa-key"></i> Senha</label> 
                        <input class="form-control" name="loginpass" id="loginpass" type="password" placeholder="********" minlength="8" maxlength="32" required/>
                    </div>
                    <button type="submit" class="css-button-rounded--sky"><i class="fa-solid fa-right-to-bracket"></i> Entrar</button>
                </form>
            </section>
            <div class="systemsupport" align="center">
                ...
                <h6>Caso você tenha um convite criptografado, você pode criar sua conta <a href="pages/Create_Account.php">aqui!</a></h6>
            </div>
        </div>
        <footer align="center">
