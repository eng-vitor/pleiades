...
<html lang="en-us">
    <head>
        <meta charset="UTF-8">
        <title> Whoops! - <?= $SERVER_NAME; ?></title>
    ...
    <body>
        ...
        <div class="errorall puff-in-center" align="center">
            ...
            <h1><?=$SERVER_NAME; ?></h1>
            <h1><i class="fa-solid fa-circle-exclamation fa-bounce" style="color: #e84118"></i> Unable to reach the page!</h1>
            <p>Sorry! An error has occurred.</p>
            <?php
                if(isset($errordb)){
                    echo '<p><code><i class="fa-solid fa-database"></i> Database error: '.$errordb.'</code></p>';
                }else{
                    header("Location: ../index.php");
                    exit(); 
                }
            ?>
            <a href="../index.php"><i class="fa-solid fa-circle-arrow-left"></i> Back</a>
        </div>
        <script>
