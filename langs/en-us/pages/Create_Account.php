...
if(isset($_SESSION['DataAccount']['id'])){
    $_SESSION['Msg'] = '<div class="alert alert-warning" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> You are logged in!</div>';
...
<html lang="en-us">
    <head>
        <meta charset="UTF-8">
        <title>Account invitation - <?= $SERVER_NAME; ?></title>
    ...
    <body>
        <div class="mininav">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-user-plus"></i> Account invitation</li>
                </ol>
            </nav>
        </div>
        <div class="bannercreateac">
            ...
            <form action="../scripts/accountquerys/validateinvite.php" method="POST" class="formcreateacc">
                <h4><i class="fa-solid fa-user-plus"></i> Account invitation</h4>
                <h6>Enter the encrypted invitation you received below to start creating your account!</h6>
                <div class="mb-3">
                    <label for="keyinvite" class="form-label"><i class="fa-solid fa-code"></i> Invitation key</label>
                ...
                <button class="btn btn-outline-success" type="submit"><i class="fa-solid fa-circle-chevron-up"></i> Validate invitation key!</button>
            </form>
        </div>    
<?php
