...
<html lang="en-us">
    ...
    <body>
            ...
            <div class="menusystemadmin">
                ...
                <div class="usernav">
                    ...
                    <ul class="dropdown-menu" id="userdropdown">
                        ...
                        <li><a class="dropdown-item disabled" href="#"><i class="fa-solid fa-terminal"></i> Admin access</a></li>
                        <li><a class="dropdown-item" href="../System.php"><i class="fa-solid fa-ticket-simple"></i> User access</a></li>
                        <li><a class="dropdown-item" href="../MyProfile.php"><i class="fa-solid fa-user"></i> My profile</a></li>
                        <li><a class="dropdown-item" href="../Change_Password.php"><i class="fa-solid fa-unlock-keyhole"></i> Change password</a></li>
                        <li><hr class="dropdown-divider"></li>
        ...
        <div class="sidenav">
            ...
            <h6><i class="fa-solid fa-user-secret"></i> Admin Panel</h6>
            <a href="SystemAdmin.php"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
            <a href="ManageSystem.php"><i class="fa-solid fa-gears"></i> System</a>
            <a href="TicketSystem.php"><i class="fa-solid fa-ticket-simple"></i> Tickets</a>
            <a href="#"><i class="fa-solid fa-database"></i> Database <span class="badge rounded-pill text-bg-secondary">Coming soon</span></a>
            <a href="#"><i class="fa-solid fa-chart-simple"></i> Reports <span class="badge rounded-pill text-bg-secondary">Coming soon</span></a>
