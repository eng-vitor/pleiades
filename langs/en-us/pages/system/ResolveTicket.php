        ...
        <section class="ticketcontent">
            ...
            <?php
                if($_SESSION['DataTicketAllSelected']['ticketstatus']!="Pendente"){
                    ...
                    This ticket has already been closed with the status <strong>'.$_SESSION['DataTicketAllSelected']['ticketstatus'].'</strong> on <strong>'.$DataTicketFinalizadoFormatada->format('d/m/Y').' at '.$DataTicketFinalizadoFormatada->format('H:i:s').'</strong>
                        </div>';
                }else{
            ...
            <div class="buttonticketfooter" align="center">
                <?php
                    if($_SESSION['DataTicketAllSelected']['ticketstatus']!="Pendente"){
                        echo '<a class="btn btn-outline-success disabled" href="#" role="button"><i class="fa-solid fa-circle-check"></i> Close as resolved</a>
                                <a class="btn btn-outline-danger disabled" href="#" role="button"><i class="fa-solid fa-square-xmark"></i> Cancel ticket</a>';
                    }else{
                        echo '<a class="btn btn-outline-success" href="../../scripts/adminquerys/resolveticketok.php?protocolticket='.$_SESSION['DataTicketAllSelected']['protocolo'].'" role="button"><i class="fa-solid fa-circle-check"></i> Close as resolved</a>
                                <a class="btn btn-outline-danger" href="../../scripts/adminquerys/rejectticket.php?protocolticket='.$_SESSION['DataTicketAllSelected']['protocolo'].'" role="button"><i class="fa-solid fa-square-xmark"></i> Reject ticket</a>';
                    }
                ?>
            </div>
        </section>
