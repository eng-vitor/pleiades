        ...
        <div class="mininav">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="MyTickets.php"><i class="fa-solid fa-user"></i> My tickets</a></li>
        ...
        <section class="ticketcontent">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-regular fa-paper-plane" style="padding-right: 5px"></i> Tag</span>
                    ...
                    <div class="col">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-solid fa-calendar-day" style="padding-right: 5px"></i> Creation date</span>
                            <input type="text" class="form-control" value="<?php $DataTicketFormatada = new DateTime($_SESSION['DataTicketSelected']['datapedido']); echo $DataTicketFormatada->format('d/m/Y').' at '.$DataTicketFormatada->format('H:i:s'); ?>" aria-describedby="ticketdateinit" disabled readonly/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-solid fa-bars-progress" style="padding-right: 5px"></i> Ticket status</span>
                    ...
                    <div class="col">
                        <div class="input-group mb-3">
                            <span class="input-group-text"><i class="fa-solid fa-calendar-week" style="padding-right: 5px"></i> Planned date</span>
                            <input type="text" class="form-control" value="<?php $DataTicketFormatadaSla = new DateTime($_SESSION['DataTicketSelected']['datasla']); echo $DataTicketFormatadaSla->format('d/m/Y').' at '.$DataTicketFormatadaSla->format('H:i:s'); ?>" aria-describedby="ticketdatasla" disabled readonly/>
                        </div>
                    </div>
                </div>
                <div class="row" align="center">
                    <?php
                    echo '<h5><i class="fa-solid fa-toolbox"></i> Tools available to the administrator</h5>'; 
                    for($z=0; $z<$_SESSION['UserTools']['CountTools']; $z++){
                        ...
                        switch ($_SESSION['UserTools'][$z][2]){
                            ...
                            case 4:
                                if(isset($_SESSION['UserTools'][$z][0])){
                                    echo '<div class="col" style="color: #2ecc71;">Network Config. <i class="fa-regular fa-circle-check"></i></div>';
                                }
                                break;
                        }
                    }
                    echo ($_SESSION['UserTools']['CountTools']==0) ? '<p><i class="fa-solid fa-wrench"></i> There are no corporate tools registered!</p>' : ''; 
                    ?>
                </div>
            </div>
            <label class="form-label"><i class="fa-solid fa-comments"></i> Chat</label>
                            ...
                            if($_SESSION['DataTicketChatSelected'][$a][2]==$_SESSION['DataAccount']['id']){
                                ...
                                echo '<div class="chat-message-left">
                                        ...
                                        <div class="message">
                                            ...
                                            <small><i class="fa-regular fa-calendar"></i> '.$DataTicketFormatadaSla->format('d/m/Y').' at <i class="fa-regular fa-clock"></i> '.$DataTicketFormatadaSla->format('H:i:s').'</small>
                                        </div>
                                    </div>';
                            }else{
                                $DataTicketFormatadaSla = new DateTime($_SESSION['DataTicketChatSelected'][$a][5]);
                ...
                <?php
                    if($_SESSION['DataTicketSelected']['ticketstatus']!='Pendente'){
                        ...
                        This ticket has already been closed with the status <strong>'.$_SESSION['DataTicketSelected']['ticketstatus'].'</strong> on <strong>'.$DataTicketFinalizadoFormatada->format('d/m/Y').' at '.$DataTicketFinalizadoFormatada->format('H:i:s').'</strong>
                                </div>';
                    }else{
                        echo '<form class="sendmsgticket" action="../scripts/ticketsquerys/sendmessageticket.php" method="POST" align="center">
                                <div class="input-group mb-3">
                                    <input type="text" id="sendmsg" name="sendmsg" class="form-control" placeholder="Type your message here" aria-describedby="submitmsg" maxlength="999" required/>
                ...
                <div class="buttonticketfooter" align="center">
                    <?php
                    if($_SESSION['DataTicketSelected']['ticketstatus']!="Pendente"){
                        echo '<a class="btn btn-outline-danger disabled" href="#" role="button"><i class="fa-solid fa-square-xmark"></i> Cancel ticket</a>';
                    }else{
                        echo '<a class="btn btn-outline-danger" href="../scripts/ticketsquerys/cancelticket.php?protocolticket='.$_SESSION['DataTicketSelected']['protocolo'].'" role="button"><i class="fa-solid fa-square-xmark"></i> Cancel ticket</a>';
                    }
                ?>
                </div>
        </section>
