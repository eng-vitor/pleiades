...
if(isset($_GET['protocolticket'])){
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> You need to select a ticket to update data!</div>';
    header("Location: ../../pages/system/ResolveTicket.php");
    exit();
}
