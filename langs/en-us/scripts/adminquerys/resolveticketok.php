...
if(isset($_GET['protocolticket'])){
    ...
    if($TicketInfoResult==1){
        ...
        $ResolveTicketNotification = "INSERT INTO notifications(id_conta,descricao,tipo_notification,data_notification,visualizado) VALUES ('".$DataTicketInfoQuery['solicitante']."','Your ticket has been resolved!','2','".date('Y-m-d H:i:s')."','0')";
        ...
        $_SESSION['Msg'] = '<div class="alert alert-success" role="alert"><i class="fa-solid fa-circle-check fa-beat"></i> Ticket has been resolved!</div>';
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> You need to select a ticket to resolve!</div>';
    header("Location: ../../pages/system/ResolveTicket.php");
    exit();
}
