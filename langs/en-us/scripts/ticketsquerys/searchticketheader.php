...
if(strlen($SearchStringData)>=3 and strlen($SearchStringData)<100){
    ...
    switch($SearchTypeData){
        ...
        case 2:
            ...
            break;
        default:
            $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> You have not selected a valid filter!</div>';
            break;
    }
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> The survey did not meet the minimum requirements!</div>';
    header("Location: ../../pages/MyTickets.php");
    exit();
}
