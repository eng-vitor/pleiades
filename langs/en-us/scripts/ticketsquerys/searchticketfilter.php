...
if($FilterDateInit=='' and $FilterDateInit==''){
        ...
        case 0:
            ...
            switch($FilterStatus){
                ...
                case 4:
                    ...
                    break;
                default:
                    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> You have not selected a valid filter option!</div>';
                    break;        
            }
            break;
        case 1:
    ...
    $_SESSION['Msg'] = '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> Invalid data entry in filters!</div>';
	header("Location: ../../pages/MyTickets.php");
	exit();
}
