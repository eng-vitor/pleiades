...
if(isset($_GET['protocolticket'])){
    ...
    if($TicketInfoResult==1){
        ...
        $CancelTicketNotification = "INSERT INTO notifications(id_conta,descricao,tipo_notification,data_notification,visualizado) VALUES ('".$_SESSION['DataAccount']['id']."','You canceled a ticket','2','".date('Y-m-d H:i:s')."','0')";
        ...
        $_SESSION['Msg'] = '<div class="alert alert-success" role="alert"><i class="fa-solid fa-circle-check fa-beat"></i> Ticket has been canceled!</div>';
